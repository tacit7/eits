...
export const COMMANDS: Command[] = [
  ...
  { id: "list.yank_title",   label: "Copy title",       keys: ["y", "t"], group: "context",
    action: { kind: "client", name: "list_yank_title" }, scope: "feature:vim-list" },
  ...
  // Scoped task nav — placed before toggle.notes/toggle.proj_picker so the scope check
  // in COMMANDS.find correctly gates these on the tasks page.
  { id: "leader.task.next",      label: "Next task",       keys: ["Space", "t", "n"], group: "navigation",
