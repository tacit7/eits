...
# Unset, blank, or non-positive/garbage values fall back to 50 (never crash boot).
agent_max_children =
  case get_env.("AGENT_SUPERVISOR_MAX_CHILDREN") do
...
config :eye_in_the_sky, :agent_supervisor_max_children, agent_max_children
