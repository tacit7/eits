defmodule EyeInTheSkyWeb.Components.AgentList do
  ...
  def canvas_submenu(assigns) do
    ~H"""
    <div class="group/canvas relative">
      <div class="w-full flex items-center gap-3 px-3 py-3 rounded-lg text-sm text-base-content hover:bg-base-content/10 transition-colors cursor-default select-none">
