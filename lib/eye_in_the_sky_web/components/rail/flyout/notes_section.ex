  ...
  def notes_filters(assigns) do
    ...
    <div class="px-2.5 py-2 border-b border-base-content/8 flex flex-col gap-2">
      ...
      <div class="flex items-center gap-0.5">
        <.type_pill label="Session" value="session" current={@note_parent_type} />
        <.type_pill label="Task" value="task" current={@note_parent_type} />
        <.type_pill label="Project" value="project" current={@note_parent_type} />
      </div>
    </div>
    """
  end
