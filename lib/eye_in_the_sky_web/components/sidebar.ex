defmodule EyeInTheSkyWeb.Components.Sidebar do
  ...
  import EyeInTheSkyWeb.Components.Sidebar.AllProjectsSection
      ...
      >
        ...
        <div class="flex items-center gap-2 px-3 py-3 border-b border-base-content/5">
          ...
          <button
            ...
            phx-click="close_mobile"
            phx-target={@myself}
            class="md:hidden btn btn-ghost btn-sm btn-square min-h-[44px] min-w-[44px] text-base-content/40"
          >
        ...
        <div class={[
          ...
          <.link
            href="/auth/logout"
            method="delete"
            class="btn btn-ghost btn-sm btn-square min-h-[44px] min-w-[44px] text-base-content/40 hover:text-red-500"
            title="Sign out"
          >
          ...
          <button
            ...
            phx-target={@myself}
            class="btn btn-ghost btn-sm btn-square min-h-[44px] min-w-[44px] text-base-content/40 hover:text-base-content/70"
