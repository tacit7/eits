defmodule EyeInTheSkyWeb.TopBar.DM do
  ...
  def toolbar(assigns) do
    ...
    <.tab_pills value_key="tab">
      ...
      />
      <:item label="Tasks" active={@active_tab == "tasks"} on_click="change_tab" value="tasks" active_class="bg-primary/10 rounded-md px-3 py-1 text-primary font-medium" />
      <:item label="Commits" active={@active_tab == "commits"} on_click="change_tab" value="commits" active_class="bg-primary/10 rounded-md px-3 py-1 text-primary font-medium" />
      <:item label="Notes" active={@active_tab == "notes"} on_click="change_tab" value="notes" active_class="bg-primary/10 rounded-md px-3 py-1 text-primary font-medium" />
      <:item label="Context" active={@active_tab == "context"} on_click="change_tab" value="context" active_class="bg-primary/10 rounded-md px-3 py-1 text-primary font-medium" />
      <:item
        label="Settings"
