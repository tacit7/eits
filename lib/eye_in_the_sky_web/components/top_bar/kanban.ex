defmodule EyeInTheSkyWeb.TopBar.Kanban do
  ...
  def toolbar(assigns) do
    ...
    ~H"""
    <%= if @bulk_mode do %>
      <span class="text-mini font-medium text-base-content">
      ...
      <button
        ...
        class="flex items-center gap-1 h-7 px-2 rounded-box text-mini font-medium bg-success/15 text-success hover:bg-success/25 transition-colors"
      ...
      <button
        ...
        class="flex items-center gap-1 h-7 px-2 rounded-box text-mini font-medium text-base-content/45 hover:text-base-content/70 hover:bg-base-content/6 transition-colors"
      ...
      <button
        ...
        class="flex items-center gap-1 h-7 px-2 rounded-box text-mini font-medium text-error hover:bg-error/10 transition-colors"
    ...
    <% else %>
      <%= if @sidebar_project do %>
        <div class="flex items-center bg-base-200/40 rounded-box p-0.5">
          <.link
            navigate={~p"/projects/#{@sidebar_project.id}/tasks"}
            class="focus-ring flex items-center gap-1 h-6 px-2 rounded-box text-mini font-medium text-base-content/45 hover:text-base-content/70 transition-colors"
            title="List view"
          >
      ...
      <div class="flex items-center gap-1">
        <button
          phx-click="toggle_bulk_mode"
          class="focus-ring flex items-center gap-1 h-7 px-2 rounded-box text-mini font-medium text-base-content/45 hover:text-base-content/70 hover:bg-base-content/6 transition-colors"
          title="Select tasks"
        >
