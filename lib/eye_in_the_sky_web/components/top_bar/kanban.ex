  ...
  def toolbar(assigns) do
    ...
    <%= if @bulk_mode do %>
      ...
      <button
        ...
        class="flex items-center gap-1 h-7 px-2 rounded-md text-mini font-medium bg-success/15 text-success hover:bg-success/25 transition-colors"
      ...
      <button
        ...
        class="flex items-center gap-1 h-7 px-2 rounded-md text-mini font-medium text-base-content/45 hover:text-base-content/70 hover:bg-base-content/6 transition-colors"
      ...
      <button
        ...
        class="flex items-center gap-1 h-7 px-2 rounded-md text-mini font-medium text-error hover:bg-error/10 transition-colors"
