defmodule EyeInTheSkyWeb.CrudHelpers do
  @moduledoc """
  ...
  ## Usage
      ...
      use EyeInTheSkyWeb.CrudHelpers, schema: MyApp.Schema
      use EyeInTheSkyWeb.CrudHelpers, schema: MyApp.Schema, repo: MyApp.Repo
  ...
  defmacro __using__(opts) do
    ...
    repo = Keyword.get(opts, :repo, EyeInTheSkyWeb.Repo)
