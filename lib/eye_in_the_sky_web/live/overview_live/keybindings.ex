defmodule EyeInTheSkyWeb.OverviewLive.Keybindings do
  ...
  @commands [
    ...
    %{
      ...
      scope_note: "Pages with a navigable list",
      bindings: [
    ...
    %{
      group: "context",
      label: "Flyout navigation",
      scope_note: "When flyout panel is open",
      bindings: [
