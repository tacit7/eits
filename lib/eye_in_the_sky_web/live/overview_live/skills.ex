defmodule EyeInTheSkyWeb.OverviewLive.Skills do
  ...
  def handle_event("duplicate_definition_file", %{"path" => path}, socket) do
    DefinitionFileActions.handle_duplicate(path, socket, &open_path_allowed?/2, &load_skills/1)
  end

  @impl true
  def handle_event("delete_definition_file", %{"path" => path}, socket) do
    DefinitionFileActions.handle_delete(path, socket, &open_path_allowed?/2, &load_skills/1,
