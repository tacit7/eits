defmodule EyeInTheSkyWeb.OverviewLive.Usage do
  ...
  defp project_breakdown_table(assigns) do
    ~H"""
    <div class="card bg-base-100 border border-base-300 shadow-sm">
  ...
  defp by_month_table(assigns) do
    ~H"""
    <div class="card bg-base-100 border border-base-300 shadow-sm">
      <div class="card-body p-4">
  ...
  defp model_breakdown_table(assigns) do
    ~H"""
    <div class="card bg-base-100 border border-base-300 shadow-sm">
      <div class="card-body p-4">
  ...
  defp top_sessions_table(assigns) do
    ~H"""
    <div class="card bg-base-100 border border-base-300 shadow-sm">
      <div class="card-body p-4">
