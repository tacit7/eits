defmodule EyeInTheSkyWeb.SDK.MessageHandler do
  @moduledoc """
  Behaviour and shared receive-loop skeleton for SDK message handlers.

  Both `EyeInTheSkyWeb.Claude.SDK` and `EyeInTheSkyWeb.Codex.SDK` run
  ...
  defmacro __using__(_opts) do
    quote do
      @behaviour EyeInTheSkyWeb.SDK.MessageHandler

      @impl EyeInTheSkyWeb.SDK.MessageHandler
  ...
  defp maybe_log_raw_line(session_id, line, log_raw_key, log_raw_prefix) do
    if EyeInTheSkyWeb.Settings.get_boolean(log_raw_key) do
