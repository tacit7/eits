defmodule EyeInTheSkyWeb.Workers.SpeakWorker do
  ...
  defp validated_voice(_), do: EyeInTheSkyWeb.Settings.get("tts_voice") || "Ava"

  defp validated_rate(r) when is_integer(r) and r >= 90 and r <= 450, do: r
  defp validated_rate(_), do: EyeInTheSkyWeb.Settings.get_integer("tts_rate") || 200
end
