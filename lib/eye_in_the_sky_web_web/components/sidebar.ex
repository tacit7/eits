defmodule EyeInTheSkyWebWeb.Components.Sidebar do
  ...
  import EyeInTheSkyWebWeb.Components.Sidebar.SystemSection
  import EyeInTheSkyWebWeb.Components.Sidebar.ChatSection
  import EyeInTheSkyWebWeb.Components.Sidebar.ProjectsSection
