defmodule EyeInTheSkyWebWeb.Helpers.PubSubHelpers do
  ...
  Broadcast by `EyeInTheSkyWeb.Tasks` on every task create/update/delete.

  | Payload          | Broadcaster                | Subscribers                         |
  |------------------|----------------------------|-------------------------------------|
  | `:tasks_changed` | `EyeInTheSkyWeb.Tasks`     | `DMLive` (via `subscribe_tasks/0`)  |
  ...
  Broadcast by `EyeInTheSkyWeb.Agents` on agent CRUD.
  ...
  Broadcast by `EyeInTheSkyWeb.Notifications`.
  ...
  Broadcast by `EyeInTheSkyWeb.Teams` on team/member changes.
