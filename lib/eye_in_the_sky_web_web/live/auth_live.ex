defmodule EyeInTheSkyWebWeb.AuthLive do
  ...
  def render(%{mode: :register, token_valid: false} = assigns) do
    ~H"""
    <div class="min-h-screen flex items-center justify-center bg-[oklch(95%_0.005_80)] dark:bg-[hsl(30,3.3%,11.8%)]">
      <div class="w-full max-w-sm px-6 text-center">
        ...
        <p class="text-xs text-zinc-500 dark:text-zinc-400 mt-2">
          Run <code class="font-mono bg-zinc-100 dark:bg-zinc-800 px-1 rounded">mix eits.register &lt;username&gt;</code> to get a new one.
        </p>
      </div>
    </div>
    """
    ...
    <div class="min-h-screen flex items-center justify-center bg-[oklch(95%_0.005_80)] dark:bg-[hsl(30,3.3%,11.8%)]">
      <div class="w-full max-w-sm px-6">
        <div class="mb-8 text-center">
          ...
          <h1 class="text-2xl font-bold text-zinc-900 dark:text-zinc-100 font-[Bricolage_Grotesque]">Register Passkey</h1>
        ...
        >
          <div :if={@error} class="text-xs text-red-500 dark:text-red-400 bg-red-50 dark:bg-red-950 rounded-lg px-3 py-2">
            {@error}
          </div>

          <div id="passkey-status" class="hidden text-xs text-zinc-500 dark:text-zinc-400 text-center py-1"></div>
    ...
    <div class="min-h-screen flex items-center justify-center bg-[oklch(95%_0.005_80)] dark:bg-[hsl(30,3.3%,11.8%)]">
      <div class="w-full max-w-sm px-6">
        <div class="mb-8 text-center">
          ...
          <h1 class="text-2xl font-bold text-zinc-900 dark:text-zinc-100 font-[Bricolage_Grotesque]">Eye in the Sky</h1>
        ...
        >
          <div>
            <label class="block text-xs font-medium text-zinc-600 dark:text-zinc-400 mb-1.5">Username</label>
            <input
              id="passkey-username"
              type="text"
