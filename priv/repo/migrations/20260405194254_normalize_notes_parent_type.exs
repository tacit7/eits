defmodule EyeInTheSky.Repo.Migrations.NormalizeNotesParentType do
  ...
  def change do
    execute(
      ...
      UPDATE notes SET parent_type = 'session' WHERE parent_type = 'sessions';
      UPDATE notes SET parent_type = 'agent' WHERE parent_type = 'agents';
      UPDATE notes SET parent_type = 'project' WHERE parent_type = 'projects';
      UPDATE notes SET parent_type = 'channel' WHERE parent_type = 'channels';
      """,
      """
