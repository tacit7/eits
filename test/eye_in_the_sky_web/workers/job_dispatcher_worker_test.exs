defmodule EyeInTheSkyWeb.Workers.JobDispatcherWorkerTest do
  use EyeInTheSkyWeb.DataCase, async: true
  use Oban.Testing, repo: EyeInTheSkyWeb.Repo

  alias EyeInTheSkyWeb.Workers.JobDispatcherWorker
  ...
  describe "perform/1" do
    ...
    test "enqueues correct worker for mix_task job type" do
      ...
      assert_enqueued(worker: EyeInTheSkyWeb.Workers.MixTaskWorker, args: %{"job_id" => job.id})
    end
